...
description: Talks, Awards, and Outreach.

# ---------------------------------------------------------------------------
# Add a gallery item by copying one block below. Drop image files into
# assets/img/Gallery/ and list them under `images:` in display order.
#   images:  one or more image paths (required)
#   label:   small accent label above the caption, e.g. a conference  (optional)
#   caption: the main line describing the photos                      (optional)
#   date:    date / location line, shown in gray                      (optional)
#   link:    make each photo clickable to an external URL             (optional)
# Tip: if a caption contains a colon ( : ), wrap it in "double quotes".
# ---------------------------------------------------------------------------
gallery_items:
  - images:
